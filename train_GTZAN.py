...
def main():
    ...
    train_data = dset.ImageFolder(root='/content/content/Dataset/train', transform=train_transform)
    valid_data = dset.ImageFolder(root='/content/content/Dataset/val', transform=valid_transform)
...
def train(train_queue, model, criterion, optimizer):
    ...
    for step, (input, target) in enumerate(train_queue):
        ...
        if step % args.report_freq == 0:
            ...
            writer.add_scalar('Accuracy/train_top1', top1.avg, step)
